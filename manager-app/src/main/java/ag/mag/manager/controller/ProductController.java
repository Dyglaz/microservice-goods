package ag.mag.manager.controller;

import ag.mag.manager.client.BadRequestException;
import ag.mag.manager.client.ProductsRestClient;
import ag.mag.manager.controller.payload.UpdateProductPayload;
import ag.mag.manager.entity.Product;
...
public class ProductController {
    ...
    public String handleNuSuchElementException(NoSuchElementException exception, Model model, HttpServletResponse response, Locale locale) {
